...
//    public static final String IP = "192.168.1.2";
    public static final String IP = "ssc.hour14.com";
...
//    public static final String VIRUSTOTAL_GET_DATA_URL = "http://"+IP+"/sms_spam_checker/virusTotalGetResponse.php";
    ...
    public static final String VIRUSTOTAL_CHECK_URL = "http://"+IP+"/virusTotalRequest.php";
    public static final String VIRUSTOTAL_GET_DATA_URL = "http://"+IP+"/virusTotalGetResponse.php";
